...
class ProcessTextTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sentence_1 = "We measured 100 materials, including Ni(CO)4 and "
            "obtained very high Thermoelectric Figures of "
            "merit ZT. These results demonstrate the utility of "
            "Machine Learning methods for materials discovery."
    ...
    def test_tokenize(self):
        ...
        tokens = [
            ["We measured 100 materials , including Ni(CO)4 and obtained very "
             ...
             "methods for materials discovery .".split()],
            "We measured 100 materials , including Ni(CO)4 and obtained very "
            "high Thermoelectric Figures of merit ZT . These results "
            "demonstrate the utility of Machine Learning methods for "
            "materials discovery .".split(),
            ["iron (II) was oxidized to obtain 5 mg Ferrous Oxide".split()],
            "iron(II) was oxidized to obtain 5 mg Ferrous Oxide".split(),
        ]

        # running the tests
        for sent, toks, so, ks in zip(
                sentences, tokens, split_oxidation, keep_sentences):
    ...
    def test_process(self):
        ...
        processed = [
            ...
            "demonstrate the utility of machine learning methods for "
            "materials discovery".split(),
            "we measured <nUm> materials , including Ni(CO)4 and obtained "
            "very high thermoelectric figures of merit ZT . these results "
            "demonstrate the utility of machine learning methods for "
            "materials discovery .".split(),
            "we measured <nUm> materials , including C4NiO4 and obtained "
            "very high thermoelectric_figures_of_merit ZT . these "
            "results_demonstrate_the_utility of machine_learning methods "
        ...
        for s, mn, cn, ep, mp, pr, mm in zip(
            ...
            proc, mats = self.mtp.process(
                s, normalize_materials=mn, convert_num=cn, exclude_punct=ep,
                make_phrases=mp)
    ...
    def test_get_ordered_integer_formula(self):
        ...
        self.assertEqual(self.mtp.get_ordered_integer_formula(
            {"Al": 1, "O": 1.5}), "Al2O3")
        self.assertEqual(self.mtp.get_ordered_integer_formula(
            {"C": 0.04, "Al": 0.02, "O": 0.5}), "AlC2O25")
    ...
    def test_normalized_formula(self):
        ...
        self.assertEqual(
            self.mtp.normalized_formula("Ni(CO)4SiO2"),
            "C4NiO6Si")

    def test_remove_accent(self):

        self.assertEqual(
            self.mtp.remove_accent("Louis Eugène Félix Néel"),
