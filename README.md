...
and run `pip install -r requirements.txt`. Note: If you are using a conda env and any packages fail to compile during the, you may need to first install those packages separately with `conda install package_name`. 
